...
import DeleteButtonComponent from '../scoreboards-management/DeleteButtonComponent';
...
export class ScoreboardsListComponent extends Component {
  ...
  render() {
    ...
    if (scoreboards.length === 0) {
      return (
        <div>
          ...
          <NavLink to="/manager/create-scoreboard">
    ...
    // This is the manager, he should see all the users scoreboards
                  ...
                  <button
                    ...
                    onClick={() =>
                      this.props.history.push(
                        `/manager/edit-scoreboard/${scoreboard.id}`
                      )
                    }
