...
export class ThreeMonthsDashboardComponent extends Component {
  ...
  exportToPdf = () => {
    const input = document.getElementById('a3monthsDashboard');
  ...
  onChange = e => {
    ...
    this.props.fetchPeriodicScoreboards('3months', e.target.value);
  };

  componentDidMount() {
    this.props.fetchPeriodicScoreboards('3months', this.state.departmentId);
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div id="a3monthsDashboard" className="my-3">
          ...
          <div className="mb-2 row h5">
            ...
            <div className="text-left col-sm-6">
              <label className="mr-sm-2">
                Last Three Months Department's Score
              </label>
